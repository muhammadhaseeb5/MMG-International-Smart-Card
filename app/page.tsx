...
import { WhatsAppIcon, FacebookIcon, InstagramIcon, TikTokIcon, ShopCartIcon } from '@/components/brand-icons';
              ...
              <div className="connections">
                ...
                <div className="social-section">
                  ...
                  <div className="social-grid">
                    ...
                    <a className="social-link tiktok-link" href="https://www.tiktok.com/@pashacollection.official?lang=en" target="_blank" rel="noopener noreferrer"><span className="brand-icon"><TikTokIcon /></span><span><strong>TikTok</strong><small>Follow Pasha Collection</small></span><ArrowUpRight /></a>
